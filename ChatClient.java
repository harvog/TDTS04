...
public class ChatClient
{
	...
	try {
		...
		switch(s) {
		case "join" : 
		    System.out.println(chatImpl.join(cref, scan.next()));
		    break;
		case "list" : 
		    System.out.print(chatImpl.list(cref));
		    break;
		case "say" : 
		    System.out.println(chatImpl.say(cref, scan.next()));
		    break;
		case "leave" : 
		    chatImpl.leave(cref);
		    break;
		...
		case "print" : 
		    ...
		    break;
		case "put" :
		    chatImpl.put(cref, scan.nextLine());
		    break;
		}
	    }
